...
(function() {
  ...
  function SailsIOClient(_providedSocketIO) {
    ...
    SailsSocket.prototype._connect = function (){
      ...
      (function selfInvoking (cb){
        ...
        self.on('disconnect', function() {
          ...
          // Get a shallow clone of the internal array of responses callbacks, in case any of the callbacks mutate it.
          var responseCbs = [].concat(self._responseCbs || []);
          // Wipe the internal array of responses callbacks before executing them, in case a callback happens to add
          ...
          // called and then wipe the list.  This prevents errors in the edge case of a responses
    ...
    SailsSocket.prototype.request = function(options, cb) {
      ...
      // the responses comes back, or if the socket disconnects.
      if (cb) {
