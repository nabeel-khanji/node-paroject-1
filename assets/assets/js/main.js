...
$(function () {
  ...
  if (typeof Chart !== 'undefined') {
    var fontFamily = '"Helvetica Neue", sans-serif'; // set defaults
    ...
    Chart.defaults.global.tooltips.yPadding = 8; // init lite line chart if element exists
      ...
      /*liteLineChartDrivers*/
      if ($(".liteLineChartOrders_shipments").length) {
          var liteLineChart = $(".liteLineChartOrders_shipments");
          var liteLineGradient = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
          liteLineGradient.addColorStop(0, 'rgba(234, 168, 84)');
          liteLineGradient.addColorStop(1, 'rgba(234, 168, 84,0)');
          var chartData = [28, 19, 28, 45, 10, 0, 5];
          ...
          var liteLineData = {
              ...
              datasets: [{
                  ...
                  pointBorderColor: "#eaa854",
                  pointBackgroundColor: "#eaa854",
                  pointBorderWidth: 2,
                  pointHoverRadius: 6,
                  pointHoverBackgroundColor: "#eaa854",
                  pointHoverBorderColor: "#eaa854",
    ...
    /*liteLineChartDrivers*/
    if ($("#liteLineChartDrivers").length) {
      var liteLineChart = $("#liteLineChartDrivers");
      var liteLineGradient = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
      liteLineGradient.addColorStop(0, 'rgba(234, 168, 84)');
      liteLineGradient.addColorStop(1, 'rgba(234, 168, 84,0)');
      var chartData = [28, 19, 28, 45, 10, 0, 5];
    ...
    //      /*liteLineChartConsumers*/
    if ($("#liteLineChartConsumers").length) {
      var liteLineChart = $("#liteLineChartConsumers");
      var liteLineGradient = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
      liteLineGradient.addColorStop(0, 'rgba(234, 168, 84)');
      liteLineGradient.addColorStop(1, 'rgba(234, 168, 84,0)');
      var chartData = [28, 19, 28, 45, 10, 0, 5];
    ...
    //      /*liteLineChartDaily*/
    if ($("#liteLineChartDaily").length) {
      var liteLineChart = $("#liteLineChartDaily");
      var liteLineGradient = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
      liteLineGradient.addColorStop(0, 'rgba(234, 168, 84)');
      liteLineGradient.addColorStop(1, 'rgba(234, 168, 84,0)');
      var chartData = [28, 19, 28, 45, 10, 0, 5];
    ...
    /*liteLineChartWeekly*/
    if ($("#liteLineChartWeekly").length) {
      var liteLineChart = $("#liteLineChartWeekly");
      var liteLineGradient = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
      liteLineGradient.addColorStop(0, 'rgba(234, 168, 84)');
      liteLineGradient.addColorStop(1, 'rgba(234, 168, 84,0)');
      var chartData = [28, 19, 28, 45, 10, 0, 5];
    ...
    /*liteLineChartMonthly*/
    if ($("#liteLineChartMonthly").length) {
      var liteLineChart = $("#liteLineChartMonthly");
      var liteLineGradient = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
      liteLineGradient.addColorStop(0, 'rgba(234, 168, 84)');
      liteLineGradient.addColorStop(1, 'rgba(234, 168, 84,0)');
      var chartData = [35, 25, 35, 45, 20, 10, 18, 26, 23, 35, 28, 32];
      if (liteLineChart.data('chart-data')) chartData = liteLineChart.data('chart-data').split(','); // line chart data
    ...
    /*liteLineChartYearly*/
    if ($("#liteLineChartYearly").length) {
      var liteLineChart = $("#liteLineChartYearly");
      var liteLineGradient = liteLineChart[0].getContext('2d').createLinearGradient(0, 0, 0, 200);
      liteLineGradient.addColorStop(0, 'rgba(234, 168, 84)');
      liteLineGradient.addColorStop(1, 'rgba(234, 168, 84,0)');
      var chartData = [28, 19, 28, 45, 10, 0, 5];
