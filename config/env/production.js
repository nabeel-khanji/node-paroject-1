...
module.exports = {
  ...
  http: {
     ...
     * (the "max-age" to include in the "Cache-Control" responses header)        *
     *                                                                          *
     ***************************************************************************/
   ...
   ***************************************************************************/
  custom: {
    baseUrl: 'https://api.xhunter.com',
    imagesUrl: '/images/avatars',
    soundTripeUrl : "https://api.soundstripe.com/v1/",
    soundTripeApiKey : "bRXSEMbgAuDhygtyuDFvoezrrTTvOCwNZ08X07DEqpZHuROdlP9V6hf45Kzfx2Gk",
    googleMapApiKey : 'AIzaSyBB2jUb3fOaMSR200XWi-zUYXiUMZjrAcw'
  ...
  microservice: {
    "notification": {
      "_token": "ih1aaml3ytfy6otnl32dfcm3123",
    ...
    "rocketChat": {
      ...
      "base_url": "http://node.cubix.co:3506/api/v1/",
      "create": {
        "uri": "users.register"
      },
      "login" :{
